...
typedef struct
{
  volatile unsigned int i2s_dao;      /* Digital Audio output register */
  volatile unsigned int i2s_dai;      /* Digital Audio input register */
  volatile unsigned int i2s_tx_fifo;  /* Transmit FIFO register */
  volatile unsigned int i2s_rx_fifo;  /* Receive FIFO register */
  volatile unsigned int i2s_stat;     /* I2S Status register */
  volatile unsigned int i2s_dma0;     /* DMA0 Configuration register*/
  volatile unsigned int i2s_dma1;     /* DMA1 Configuration register*/
  volatile unsigned int i2s_irq;      /* Interrupt Request Control register*/
  volatile unsigned int i2s_tx_rate;  /* Transmit bit rate register*/
  volatile unsigned int i2s_rx_rate;  /* Receive bitrate register*/
} I2S_REGS_T;
